...
# =============================================================================
# 2. Vocabulary loading — DeepSC custom vocab + diffusion tokenizer
# =============================================================================
...
def _load_split(split_name):
    """Load a train/val/test split from the pre-processed pkl files."""
...
# =============================================================================
# 3. Load canonical train / val / test splits from pkl files
# =============================================================================
...
def _tokenize(texts):
    """Batch-encode a list of strings into lists of token IDs."""
...
class ChannelDiffusionLM(nn.Module):
    ...
    def encode(self, input_ids, attention_mask=None):
        """Encode token IDs into continuous latent representations z0."""
        B, L = input_ids.shape
...
def channel_diffusion_loss(model, batch, lambda_ce=1.0, lambda_ce_denoise=0.1,
    ...
    # Falls back gracefully if the batch was built without content_mask
...
SAMPLE_EVERY = 1000
LAMBDA_CE    = 1.0
CKPT_PATH    = "channel_diffusion_new_ckpt_Rayleigh.pt"
